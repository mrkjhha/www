				...
				<div id="name_hp_input">
					<ul>
						<li>
							...
							<input type="text" id="name" name="name" class="name_input" placeholder="이름을 입력하세요" required>
						</li>
						<li>
							<label for="hp" class="hidden"></label>
							<input type="text" id="hp" name="hp" class="name_input" placeholder="'-' 를 포함한 전화번호를 입력하세요: ex) 010-0000-0000" required>
						</li>
					</ul>
				</div>
